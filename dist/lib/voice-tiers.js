...
exports.INDIAN_LANGUAGE_CODES = exports.USE_CASES = exports.VOICE_TIERS = void 0;
exports.getRecommendedTier = getRecommendedTier;
exports.resolveTierProviders = resolveTierProviders;
...
exports.INDIAN_LANGUAGE_CODES = new Set([
 ...
 */
function getRecommendedTier(useCaseId) {
    const useCase = exports.USE_CASES.find((u) => u.id === useCaseId);
    if (!useCase) {
        return {
            tier: exports.VOICE_TIERS.find((t) => t.id === "professional"),
            reason: "Professional tier works well for most use cases",
        };
    }
    return {
        tier: exports.VOICE_TIERS.find((t) => t.id === useCase.suggestedTier),
 ...
 */
function resolveTierProviders(tierId, region, language, gender) {
    const tier = exports.VOICE_TIERS.find((t) => t.id === tierId) ?? exports.VOICE_TIERS[1];
...
function buildSystemPrompt(params) {
    const tier = exports.VOICE_TIERS.find((t) => t.id === params.tierId) ?? exports.VOICE_TIERS[1];
    const isIndian = exports.INDIAN_LANGUAGE_CODES.has(params.language);
    ...
    const langInstruction = isIndian
        ...
        : `\nAlways respond in clear, natural ${params.language === "es" ? "Spanish"
